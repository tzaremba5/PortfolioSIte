            ...
            <div className='flex-col w-3/4'>
              <div className='text-light text-[18px]'>
                ...
                <div className='text-[15px] md:text-[13.5px] font-light rounded-b-3xl leading-4'>
                  Implements the mark and sweep algoirthm to collect unsused memory

              </div>
            </div> 
            <div className='ml-[10px]'>
              <Image src='https://img.icons8.com/external-itim2101-lineal-itim2101/512/external-garbage-plastic-pollution-itim2101-lineal-itim2101.png' width='75' height='75'/>
            </div>
          </div>
...
// https://img.icons8.com/external-itim2101-lineal-itim2101/512/external-garbage-plastic-pollution-itim2101-lineal-itim2101.png
