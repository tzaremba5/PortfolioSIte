...
function Header() {
  return (
    <div className='w-screen fixed bg-slate-50 z-20 py-[5px] bg-opacity-80'>
        <div className='flex justify-end mr-[20px] md:mr-[30px] h-full'>
            <a href='https://github.com/TeddyZaremba' target='_blank' rel="noreferrer">
                <div className='border-slate-900 border-2 rounded-full m-[5px] p-[5px] cursor-pointer mr-[0px] md:mr-[10px]'>
