            ...
            <div className='flex-col w-3/4'>
              <div className='text-light text-[18px]'>
                ...
                <div className='text-[15px] md:text-[13.5px] font-light rounded-b-3xl leading-4'>
                  A python app that analyzes the CTA Database. It allows the user to track metrics such as the number of riders at a given station or in a given year.
              </div>
            </div> 
            <div className='ml-[10px]'>
              <Image src='https://img.icons8.com/ios/512/train.png' width='75' height='75'/>
            </div>
          </div>
