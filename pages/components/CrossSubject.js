       ...
       '>
          <div className='ml-[10px] flex text-[15px]'>
            ...
            <div className='ml-[10px]'>
              <Image src='https://img.icons8.com/dotty/512/critical-thinking.png' width='75' height='75'/>
            </div>
          </div>
          <div className='flex-col ml-[10px] mt-[15px] text-[12px] md:text-[13.5px]'>
            ...
            <a href='https://github.com/TeddyZaremba/Cross-Subject-Motor-Imagery' target='_blank' rel="noreferrer">
