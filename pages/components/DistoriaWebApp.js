       ...
       '>
          <div className='ml-[10px] flex text-[15px]'>
            ...
            <div className='ml-[10px]'>
              <Image src='https://img.icons8.com/external-dreamstale-lineal-dreamstale/512/external-distort-design-dreamstale-lineal-dreamstale.png' width='75' height='75'/>
            </div>
          </div>
          <div className='flex-col ml-[10px] mt-[15px] text-[12px] md:text-[13.5px]'>
            ...
            <a href='https://github.com/TeddyZaremba/Distortia' target='_blank' rel="noreferrer">
...
export default DistoriaWebApp
//https://img.icons8.com/external-dreamstale-lineal-dreamstale/512/external-distort-design-dreamstale-lineal-dreamstale.png