       ...
       '>
          <div className='ml-[10px] flex text-[15px]'>
            ...
            <div className='ml-[10px] select-none'>
              <Image src='https://img.icons8.com/external-smashingstocks-basic-outline-smashing-stocks/512/external-Earthquake-natural-disaster-icon-smashingstocks-basic-outline-smashing-stocks-6.png' width='75' height='75'/>
            </div>
          </div>
